import { Box, Button, Container, FormatNumber, Group, Heading, Stack, Text, Carousel, IconButton, Image, Breadcrumb, Center } from '@chakra-ui/react';
    ...
    <Center>
      <Stack gap={'48px'} margin={'48px'} width={'8xl'}>
          ...
          <Center>
            <Breadcrumb.Root>
              <Breadcrumb.List>
                ...
                <Breadcrumb.Item>
                  <Breadcrumb.CurrentLink>{hotel.name}</Breadcrumb.CurrentLink>
                </Breadcrumb.Item>
              </Breadcrumb.List>
            </Breadcrumb.Root>
          </Center>
        ...
        {pictures && pictures.length > 0 && (
          <Center>
            <Carousel.Root slideCount={pictures.length} allowMouseDrag={true} autoplay={true} loop={true} maxWidth={'6xl'} >
